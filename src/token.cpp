...
const char *tokenTypeToString(TokenType tokenType) {
    ...
    switch (tokenType) {
        ...
        TOKEN_TYPE_CASE(CaretEqual)
        TOKEN_TYPE_CASE(PipeEqual)
        TOKEN_TYPE_CASE(Not)
        TOKEN_TYPE_CASE(And)
        TOKEN_TYPE_CASE(Or)
        ...
        TOKEN_TYPE_CASE(HashIdentifier)
        TOKEN_TYPE_CASE(Self)
        TOKEN_TYPE_CASE(Enum)
        TOKEN_TYPE_CASE(Struct)
        TOKEN_TYPE_CASE(Var)
        TOKEN_TYPE_CASE(Const)
        TOKEN_TYPE_CASE(Bind)
        TOKEN_TYPE_CASE(Unwrap)
